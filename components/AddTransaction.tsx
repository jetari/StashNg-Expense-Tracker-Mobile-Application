          ...
          <Card>
            <TextInput
              ...
              onChangeText={(text) => {
                ...
                // Check if the value is less than 1 or if it's negative
                if (!isNaN(floatValue) && (floatValue < 1 || floatValue < 0)) {
                  setValidationMessage("Amount must be at least #1");
                } else {
                  setValidationMessage("");
                }

                // Set the amount state
